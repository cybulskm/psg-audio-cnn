...
def parse_annotations(rml_file_path):
    ...
    for event in root.findall('.//ns:Event', namespace):
        ...
        if "apnea" in event_type.lower():
            # Keep original apnea type for proper classification
...
def main():
    ...
    print("🚀 STARTING 100-PATIENT PREPROCESSING")
    print("=" * 60)
    ...
    # Sort and limit to 100 patients
    rml_files.sort()
    MAX_PATIENTS = 100
    ...
    if all_segments:
        ...
        # Save to file
        output_file = os.path.join(output_dir, "100_patients_processed.pkl")
